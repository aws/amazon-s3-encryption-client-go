...
//	svc := kms.NewFromConfig(tConfig)
//
//	handler, err := newKMSContextKeyringEntryWithAnyCMK(svc)(ObjectMetadata{KeyringAlg: KMSContextKeyring, CEKAlg: "AES/GCM/NoPadding", MatDesc: `{"aws:x-amz-cek-alg": "AES/GCM/NoPadding"}`})
//	if err != nil {
...
//	_, err := newKMSContextKeyringEntryWithAnyCMK(kmsClient)(ObjectMetadata{KeyringAlg: KMSContextKeyring, CEKAlg: "MismatchCEKValue", MatDesc: `{"aws:x-amz-cek-alg": "AES/GCM/NoPadding"}`})
//	if err == nil {
...
//	kmsClient := kms.NewFromConfig(awstesting.Config())
//	_, err := newKMSContextKeyringEntryWithAnyCMK(kmsClient)(ObjectMetadata{KeyringAlg: KMSContextKeyring, CEKAlg: "AES/GCM/NoPadding", MatDesc: `{}`})
//	if err == nil {
//		t.Fatal("expected error, but got none")
//	}
//
...
//	kmsClient := kms.NewFromConfig(awstesting.Config())
//	_, err := newKMSContextKeyringEntryWithAnyCMK(kmsClient)(ObjectMetadata{KeyringAlg: KMSKeyring, CEKAlg: "AES/GCM/NoPadding", MatDesc: `{}`})
//	if err == nil {
//		t.Fatal("expected error, but got none")
//	}
//
...
//	svc := kms.NewFromConfig(tConfig)
//
//	handler, err := newKMSContextKeyringEntryWithCMK(svc, "thisKey")(ObjectMetadata{KeyringAlg: KMSContextKeyring, CEKAlg: "AES/GCM/NoPadding", MatDesc: `{"aws:x-amz-cek-alg": "AES/GCM/NoPadding"}`})
//	if err != nil {
//		t.Errorf("expected no error, but received %v", err)
//	}
//
...
//		t.Errorf("expected KeyringEntry to be present")
//	} else if keyring == nil {
